...
************************
:command:`rpn-to-gemlam`
************************

ECCC RPN to NEMO Atmospheric Forcing Conversion Tool for SalishSeaCast
======================================================================
...
The code and documentation of the :command:`rpn-to-gemlam` tool for
